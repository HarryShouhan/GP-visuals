  ...
  return (
    <div>
        <div className="credits flex flex-col items-center gap-4 md:gap-[5vw] mt-6 md:mt-[10vw] px-4">
              ...
              <p className='text-center font-[font2] text-gray-600 w-full md:w-[50vw] text-sm md:text-base'>Thank you for visiting my portfolio. This space showcases my creative work, skills, and passion for digital content creation. I am constantly learning, improving, and exploring new ideas to deliver high-quality results. Your support and feedback are always appreciated.</p>
        </div>
